...
from api.pos.chat import TelegramChatWithEligibilityRulesFDO
...
async def get_chat(
...
) -> TelegramChatWithEligibilityRulesFDO:
    ...
    try:
        ...
        return TelegramChatWithEligibilityRulesFDO.from_dto(result)
